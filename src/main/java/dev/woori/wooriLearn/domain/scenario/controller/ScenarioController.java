...
/**
 *  제공 기능:
 *  1) GET  /users/me/scenarios/{scenarioId}              : 저장된 위치가 있으면 그 스텝부터, 없으면 시작 스텝 반환
 *  2) PUT  /users/me/scenarios/{scenarioId}/progress     : 시나리오 진행률 업데이트
 *  3) POST /users/me/scenarios/{scenarioId}/next-step    : 다음 스텝으로 진행(퀴즈 게이트 포함)
 */
@RestController
@RequiredArgsConstructor
@RequestMapping(
        value = "/users/me/scenarios/{scenarioId}",
...
public class ScenarioController {
     ...
     * ex) GET /users/me/scenarios/{scenarioId}
     *
     * 규칙
    ...
    /**
     * 시나리오 진행률 저장
     * ex) PUT /users/me/scenarios/{scenarioId}/progress
     *
     * 규칙
     * - 정루트 기준으로 진행률 계산
     ...
     * ex) POST /users/me/scenarios/{scenarioId}/next-step
     * Body 예:
     *   - { "nowStepId": 102 }
